...
const CardEditForm: React.FC<CardEditFormProps> = ({ card, onUpdateSuccess }) => {
  ...
  // Sincroniza o estado interno com as props do card
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      onUpdateSuccess(); // Notifica o pai para atualizar a lista ou redirecionar
    }
